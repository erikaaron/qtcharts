...
const QMetaObject CustomTableModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_CustomTableModel.data,
      qt_meta_data_CustomTableModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CustomTableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomTableModel.stringdata0))
        return static_cast<void*>(const_cast< CustomTableModel*>(this));
