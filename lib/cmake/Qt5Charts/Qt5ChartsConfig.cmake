...
set(_qt5Charts_install_prefix "/usr/lib64/qt5")

# For backwards compatibility only. Use Qt5Charts_VERSION instead.
set(Qt5Charts_VERSION_STRING 5.7.1)
...
macro(_populate_Charts_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "/usr/lib64/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Charts)
    ...
    set(_Qt5Charts_OWN_INCLUDE_DIRS "/usr/include/qt5/" "/usr/include/qt5/QtCharts")
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "/usr/include/qt5/QtCharts/5.7.1"
        "/usr/include/qt5/QtCharts/5.7.1/QtCharts"
    )
    ...
    foreach(_module_dep ${_Qt5Charts_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.7.1 ${_Qt5Charts_FIND_VERSION_EXACT}
    ...
    _populate_Charts_target_properties(RELEASE "libQt5Charts.so.5.7.1" "" )
