...
void QtCharts::DeclarativeAxes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeAxes::axisXChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DeclarativeAxes::*_t)(QAbstractAxis * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeAxes::axisYChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (DeclarativeAxes::*_t)(QAbstractAxis * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeAxes::axisXTopChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (DeclarativeAxes::*_t)(QAbstractAxis * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeAxes::axisYRightChanged)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QtCharts::DeclarativeAxes::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__DeclarativeAxes.data,
      qt_meta_data_QtCharts__DeclarativeAxes,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::DeclarativeAxes::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__DeclarativeAxes.stringdata0))
        return static_cast<void*>(const_cast< DeclarativeAxes*>(this));
