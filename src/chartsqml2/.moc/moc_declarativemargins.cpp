...
void QtCharts::DeclarativeMargins::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeMargins::topChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DeclarativeMargins::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeMargins::bottomChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (DeclarativeMargins::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeMargins::leftChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (DeclarativeMargins::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeMargins::rightChanged)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QtCharts::DeclarativeMargins::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__DeclarativeMargins.data,
      qt_meta_data_QtCharts__DeclarativeMargins,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::DeclarativeMargins::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__DeclarativeMargins.stringdata0))
        return static_cast<void*>(const_cast< DeclarativeMargins*>(this));
    if (!strcmp(_clname, "QMargins"))
        return static_cast< QMargins*>(const_cast< DeclarativeMargins*>(this));
