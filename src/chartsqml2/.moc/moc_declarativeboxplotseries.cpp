...
void QtCharts::DeclarativeBoxSet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxSet::changedValues)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxSet::changedValue)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxSet::brushFilenameChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QtCharts::DeclarativeBoxSet::staticMetaObject = {
    { &QBoxSet::staticMetaObject, qt_meta_stringdata_QtCharts__DeclarativeBoxSet.data,
      qt_meta_data_QtCharts__DeclarativeBoxSet,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::DeclarativeBoxSet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__DeclarativeBoxSet.stringdata0))
        return static_cast<void*>(const_cast< DeclarativeBoxSet*>(this));
...
void QtCharts::DeclarativeBoxPlotSeries::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 17: { DeclarativeBoxSet* _r = _t->at((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< DeclarativeBoxSet**>(_a[0]) = _r; }  break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::axisXChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DeclarativeBoxPlotSeries::*_t)(QAbstractAxis * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::axisYChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (DeclarativeBoxPlotSeries::*_t)(QAbstractAxis * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::axisXTopChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (DeclarativeBoxPlotSeries::*_t)(QAbstractAxis * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::axisYRightChanged)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::clicked)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::hovered)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (DeclarativeBoxPlotSeries::*_t)(DeclarativeBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::pressed)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (DeclarativeBoxPlotSeries::*_t)(DeclarativeBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::released)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (DeclarativeBoxPlotSeries::*_t)(DeclarativeBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::doubleClicked)) {
                *result = 8;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeBoxPlotSeries::brushFilenameChanged)) {
                *result = 9;
                return;
            }
        }
...
const QMetaObject QtCharts::DeclarativeBoxPlotSeries::staticMetaObject = {
    { &QBoxPlotSeries::staticMetaObject, qt_meta_stringdata_QtCharts__DeclarativeBoxPlotSeries.data,
      qt_meta_data_QtCharts__DeclarativeBoxPlotSeries,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::DeclarativeBoxPlotSeries::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__DeclarativeBoxPlotSeries.stringdata0))
        return static_cast<void*>(const_cast< DeclarativeBoxPlotSeries*>(this));
    if (!strcmp(_clname, "QQmlParserStatus"))
        return static_cast< QQmlParserStatus*>(const_cast< DeclarativeBoxPlotSeries*>(this));
