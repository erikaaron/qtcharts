...
#include "../scatterchart/qscatterseries.h"
...
void QtCharts::QScatterSeries::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScatterSeries::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QScatterSeries::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScatterSeries::borderColorChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScatterSeries::markerShapeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScatterSeries::markerSizeChanged)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QtCharts::QScatterSeries::staticMetaObject = {
    { &QXYSeries::staticMetaObject, qt_meta_stringdata_QtCharts__QScatterSeries.data,
      qt_meta_data_QtCharts__QScatterSeries,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QScatterSeries::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QScatterSeries.stringdata0))
        return static_cast<void*>(const_cast< QScatterSeries*>(this));
