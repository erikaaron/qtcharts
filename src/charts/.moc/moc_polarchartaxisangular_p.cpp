...
void QtCharts::PolarChartAxisAngular::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PolarChartAxisAngular *_t = static_cast<PolarChartAxisAngular *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::PolarChartAxisAngular::staticMetaObject = {
    { &PolarChartAxis::staticMetaObject, qt_meta_stringdata_QtCharts__PolarChartAxisAngular.data,
      qt_meta_data_QtCharts__PolarChartAxisAngular,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::PolarChartAxisAngular::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__PolarChartAxisAngular.stringdata0))
        return static_cast<void*>(const_cast< PolarChartAxisAngular*>(this));
