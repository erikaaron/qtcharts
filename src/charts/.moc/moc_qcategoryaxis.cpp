...
void QtCharts::QCategoryAxis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QCategoryAxis *_t = static_cast<QCategoryAxis *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QCategoryAxis::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCategoryAxis::categoriesChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QCategoryAxis::*_t)(QCategoryAxis::AxisLabelsPosition );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCategoryAxis::labelsPositionChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QtCharts::QCategoryAxis::staticMetaObject = {
    { &QValueAxis::staticMetaObject, qt_meta_stringdata_QtCharts__QCategoryAxis.data,
      qt_meta_data_QtCharts__QCategoryAxis,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QCategoryAxis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QCategoryAxis.stringdata0))
        return static_cast<void*>(const_cast< QCategoryAxis*>(this));
