...
void QtCharts::PolarChartLogValueAxisRadial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PolarChartLogValueAxisRadial *_t = static_cast<PolarChartLogValueAxisRadial *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::PolarChartLogValueAxisRadial::staticMetaObject = {
    { &PolarChartAxisRadial::staticMetaObject, qt_meta_stringdata_QtCharts__PolarChartLogValueAxisRadial.data,
      qt_meta_data_QtCharts__PolarChartLogValueAxisRadial,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::PolarChartLogValueAxisRadial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__PolarChartLogValueAxisRadial.stringdata0))
        return static_cast<void*>(const_cast< PolarChartLogValueAxisRadial*>(this));
