...
#include "../candlestickchart/qhcandlestickmodelmapper.h"
...
void QtCharts::QHCandlestickModelMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHCandlestickModelMapper::timestampColumnChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QHCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHCandlestickModelMapper::openColumnChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QHCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHCandlestickModelMapper::highColumnChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QHCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHCandlestickModelMapper::lowColumnChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QHCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHCandlestickModelMapper::closeColumnChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QHCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHCandlestickModelMapper::firstSetRowChanged)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QHCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHCandlestickModelMapper::lastSetRowChanged)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject QtCharts::QHCandlestickModelMapper::staticMetaObject = {
    { &QCandlestickModelMapper::staticMetaObject, qt_meta_stringdata_QtCharts__QHCandlestickModelMapper.data,
      qt_meta_data_QtCharts__QHCandlestickModelMapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QHCandlestickModelMapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QHCandlestickModelMapper.stringdata0))
        return static_cast<void*>(const_cast< QHCandlestickModelMapper*>(this));
