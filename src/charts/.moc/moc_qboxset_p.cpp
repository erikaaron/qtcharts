...
#include "../boxplotchart/qboxset_p.h"
...
void QtCharts::QBoxSetPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSetPrivate::restructuredBox)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QBoxSetPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSetPrivate::updatedBox)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QBoxSetPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSetPrivate::updatedLayout)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QtCharts::QBoxSetPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__QBoxSetPrivate.data,
      qt_meta_data_QtCharts__QBoxSetPrivate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QBoxSetPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QBoxSetPrivate.stringdata0))
        return static_cast<void*>(const_cast< QBoxSetPrivate*>(this));
