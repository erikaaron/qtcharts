...
void QtCharts::ChartDateTimeAxisY::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ChartDateTimeAxisY *_t = static_cast<ChartDateTimeAxisY *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::ChartDateTimeAxisY::staticMetaObject = {
    { &VerticalAxis::staticMetaObject, qt_meta_stringdata_QtCharts__ChartDateTimeAxisY.data,
      qt_meta_data_QtCharts__ChartDateTimeAxisY,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::ChartDateTimeAxisY::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__ChartDateTimeAxisY.stringdata0))
        return static_cast<void*>(const_cast< ChartDateTimeAxisY*>(this));
