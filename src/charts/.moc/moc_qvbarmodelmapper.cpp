...
void QtCharts::QVBarModelMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QVBarModelMapper *_t = static_cast<QVBarModelMapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QVBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBarModelMapper::seriesReplaced)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QVBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBarModelMapper::modelReplaced)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QVBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBarModelMapper::firstBarSetColumnChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QVBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBarModelMapper::lastBarSetColumnChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QVBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBarModelMapper::firstRowChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QVBarModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBarModelMapper::rowCountChanged)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject QtCharts::QVBarModelMapper::staticMetaObject = {
    { &QBarModelMapper::staticMetaObject, qt_meta_stringdata_QtCharts__QVBarModelMapper.data,
      qt_meta_data_QtCharts__QVBarModelMapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QVBarModelMapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QVBarModelMapper.stringdata0))
        return static_cast<void*>(const_cast< QVBarModelMapper*>(this));
