...
void QtCharts::ChartPresenter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChartPresenter::plotAreaChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QtCharts::ChartPresenter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__ChartPresenter.data,
      qt_meta_data_QtCharts__ChartPresenter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
