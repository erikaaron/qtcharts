...
void QtCharts::QValueAxis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QValueAxis *_t = static_cast<QValueAxis *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QValueAxis::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QValueAxis::minChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QValueAxis::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QValueAxis::maxChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QValueAxis::*_t)(qreal , qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QValueAxis::rangeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QValueAxis::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QValueAxis::tickCountChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QValueAxis::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QValueAxis::minorTickCountChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QValueAxis::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QValueAxis::labelFormatChanged)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject QtCharts::QValueAxis::staticMetaObject = {
    { &QAbstractAxis::staticMetaObject, qt_meta_stringdata_QtCharts__QValueAxis.data,
      qt_meta_data_QtCharts__QValueAxis,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QValueAxis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QValueAxis.stringdata0))
        return static_cast<void*>(const_cast< QValueAxis*>(this));
