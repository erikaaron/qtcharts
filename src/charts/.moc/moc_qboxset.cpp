...
#include "../boxplotchart/qboxset.h"
...
void QtCharts::QBoxSet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QBoxSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QBoxSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QBoxSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::doubleClicked)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QBoxSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::penChanged)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QBoxSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::brushChanged)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (QBoxSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::valuesChanged)) {
                *result = 7;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::valueChanged)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (QBoxSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxSet::cleared)) {
                *result = 9;
                return;
            }
        }
...
const QMetaObject QtCharts::QBoxSet::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__QBoxSet.data,
      qt_meta_data_QtCharts__QBoxSet,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QBoxSet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QBoxSet.stringdata0))
        return static_cast<void*>(const_cast< QBoxSet*>(this));
