...
void QtCharts::ChartThemeManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ChartThemeManager *_t = static_cast<ChartThemeManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::ChartThemeManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__ChartThemeManager.data,
      qt_meta_data_QtCharts__ChartThemeManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::ChartThemeManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__ChartThemeManager.stringdata0))
        return static_cast<void*>(const_cast< ChartThemeManager*>(this));
