...
#include "../boxplotchart/qvboxplotmodelmapper.h"
...
void QtCharts::QVBoxPlotModelMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBoxPlotModelMapper::seriesReplaced)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QVBoxPlotModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBoxPlotModelMapper::modelReplaced)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QVBoxPlotModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBoxPlotModelMapper::firstBoxSetColumnChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QVBoxPlotModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBoxPlotModelMapper::lastBoxSetColumnChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QVBoxPlotModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBoxPlotModelMapper::firstRowChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QVBoxPlotModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVBoxPlotModelMapper::rowCountChanged)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject QtCharts::QVBoxPlotModelMapper::staticMetaObject = {
    { &QBoxPlotModelMapper::staticMetaObject, qt_meta_stringdata_QtCharts__QVBoxPlotModelMapper.data,
      qt_meta_data_QtCharts__QVBoxPlotModelMapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QVBoxPlotModelMapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QVBoxPlotModelMapper.stringdata0))
        return static_cast<void*>(const_cast< QVBoxPlotModelMapper*>(this));
