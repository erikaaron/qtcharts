...
#include "../candlestickchart/candlestick_p.h"
...
void QtCharts::Candlestick::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Candlestick::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Candlestick::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Candlestick::*_t)(QCandlestickSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Candlestick::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (Candlestick::*_t)(QCandlestickSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Candlestick::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (Candlestick::*_t)(QCandlestickSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Candlestick::doubleClicked)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject QtCharts::Candlestick::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_QtCharts__Candlestick.data,
      qt_meta_data_QtCharts__Candlestick,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::Candlestick::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__Candlestick.stringdata0))
        return static_cast<void*>(const_cast< Candlestick*>(this));
