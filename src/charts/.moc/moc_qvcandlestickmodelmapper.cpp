...
#include "../candlestickchart/qvcandlestickmodelmapper.h"
...
void QtCharts::QVCandlestickModelMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVCandlestickModelMapper::timestampRowChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QVCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVCandlestickModelMapper::openRowChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QVCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVCandlestickModelMapper::highRowChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QVCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVCandlestickModelMapper::lowRowChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QVCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVCandlestickModelMapper::closeRowChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QVCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVCandlestickModelMapper::firstSetColumnChanged)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QVCandlestickModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QVCandlestickModelMapper::lastSetColumnChanged)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject QtCharts::QVCandlestickModelMapper::staticMetaObject = {
    { &QCandlestickModelMapper::staticMetaObject, qt_meta_stringdata_QtCharts__QVCandlestickModelMapper.data,
      qt_meta_data_QtCharts__QVCandlestickModelMapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QVCandlestickModelMapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QVCandlestickModelMapper.stringdata0))
        return static_cast<void*>(const_cast< QVCandlestickModelMapper*>(this));
