...
void QtCharts::QPieSeries::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeries::added)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QPieSeries::*_t)(QList<QPieSlice*> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeries::removed)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            typedef void (QPieSeries::*_t)(QPieSlice * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeries::pressed)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QPieSeries::*_t)(QPieSlice * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeries::released)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QPieSeries::*_t)(QPieSlice * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeries::doubleClicked)) {
                *result = 6;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeries::countChanged)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (QPieSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeries::sumChanged)) {
                *result = 8;
                return;
            }
        }
...
const QMetaObject QtCharts::QPieSeries::staticMetaObject = {
    { &QAbstractSeries::staticMetaObject, qt_meta_stringdata_QtCharts__QPieSeries.data,
      qt_meta_data_QtCharts__QPieSeries,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
