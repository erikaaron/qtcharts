...
void QtCharts::QAbstractSeries::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QAbstractSeries *_t = static_cast<QAbstractSeries *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QAbstractSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAbstractSeries::nameChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QAbstractSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAbstractSeries::visibleChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QAbstractSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAbstractSeries::opacityChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QAbstractSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAbstractSeries::useOpenGLChanged)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QtCharts::QAbstractSeries::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__QAbstractSeries.data,
      qt_meta_data_QtCharts__QAbstractSeries,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
