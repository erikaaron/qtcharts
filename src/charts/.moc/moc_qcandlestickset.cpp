...
#include "../candlestickchart/qcandlestickset.h"
...
void QtCharts::QCandlestickSet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::doubleClicked)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::timestampChanged)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::openChanged)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::highChanged)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::lowChanged)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::closeChanged)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::brushChanged)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (QCandlestickSet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSet::penChanged)) {
                *result = 11;
                return;
            }
        }
...
const QMetaObject QtCharts::QCandlestickSet::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__QCandlestickSet.data,
      qt_meta_data_QtCharts__QCandlestickSet,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QCandlestickSet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QCandlestickSet.stringdata0))
        return static_cast<void*>(const_cast< QCandlestickSet*>(this));
