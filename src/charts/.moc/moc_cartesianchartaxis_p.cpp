...
void QtCharts::CartesianChartAxis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CartesianChartAxis *_t = static_cast<CartesianChartAxis *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::CartesianChartAxis::staticMetaObject = {
    { &ChartAxisElement::staticMetaObject, qt_meta_stringdata_QtCharts__CartesianChartAxis.data,
      qt_meta_data_QtCharts__CartesianChartAxis,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::CartesianChartAxis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__CartesianChartAxis.stringdata0))
        return static_cast<void*>(const_cast< CartesianChartAxis*>(this));
    if (!strcmp(_clname, "org.qt-project.Qt.QGraphicsLayoutItem"))
        return static_cast< QGraphicsLayoutItem*>(const_cast< CartesianChartAxis*>(this));
