...
#include "../piechart/qhpiemodelmapper.h"
...
void QtCharts::QHPieModelMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHPieModelMapper::seriesReplaced)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QHPieModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHPieModelMapper::modelReplaced)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QHPieModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHPieModelMapper::valuesRowChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QHPieModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHPieModelMapper::labelsRowChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QHPieModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHPieModelMapper::firstColumnChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QHPieModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHPieModelMapper::columnCountChanged)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject QtCharts::QHPieModelMapper::staticMetaObject = {
    { &QPieModelMapper::staticMetaObject, qt_meta_stringdata_QtCharts__QHPieModelMapper.data,
      qt_meta_data_QtCharts__QHPieModelMapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QHPieModelMapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QHPieModelMapper.stringdata0))
        return static_cast<void*>(const_cast< QHPieModelMapper*>(this));
