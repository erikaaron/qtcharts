...
#include "../piechart/qpieseries_p.h"
...
void QtCharts::QPieSeriesPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeriesPrivate::calculatedDataChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            typedef void (QPieSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeriesPrivate::pieStartAngleChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QPieSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeriesPrivate::pieEndAngleChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QPieSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeriesPrivate::horizontalPositionChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QPieSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPieSeriesPrivate::verticalPositionChanged)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject QtCharts::QPieSeriesPrivate::staticMetaObject = {
    { &QAbstractSeriesPrivate::staticMetaObject, qt_meta_stringdata_QtCharts__QPieSeriesPrivate.data,
      qt_meta_data_QtCharts__QPieSeriesPrivate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
