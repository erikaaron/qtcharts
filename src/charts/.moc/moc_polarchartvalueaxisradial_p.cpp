...
void QtCharts::PolarChartValueAxisRadial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PolarChartValueAxisRadial *_t = static_cast<PolarChartValueAxisRadial *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::PolarChartValueAxisRadial::staticMetaObject = {
    { &PolarChartAxisRadial::staticMetaObject, qt_meta_stringdata_QtCharts__PolarChartValueAxisRadial.data,
      qt_meta_data_QtCharts__PolarChartValueAxisRadial,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::PolarChartValueAxisRadial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__PolarChartValueAxisRadial.stringdata0))
        return static_cast<void*>(const_cast< PolarChartValueAxisRadial*>(this));
