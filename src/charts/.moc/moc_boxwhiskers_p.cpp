...
#include "../boxplotchart/boxwhiskers_p.h"
...
void QtCharts::BoxWhiskers::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoxWhiskers::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoxWhiskers::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (BoxWhiskers::*_t)(QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoxWhiskers::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (BoxWhiskers::*_t)(QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoxWhiskers::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (BoxWhiskers::*_t)(QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoxWhiskers::doubleClicked)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject QtCharts::BoxWhiskers::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_QtCharts__BoxWhiskers.data,
      qt_meta_data_QtCharts__BoxWhiskers,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::BoxWhiskers::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__BoxWhiskers.stringdata0))
        return static_cast<void*>(const_cast< BoxWhiskers*>(this));
