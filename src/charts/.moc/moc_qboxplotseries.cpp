...
#include "../boxplotchart/qboxplotseries.h"
...
void QtCharts::QBoxPlotSeries::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeries::*_t)(QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeries::*_t)(QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeries::*_t)(QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::doubleClicked)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::countChanged)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::penChanged)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::brushChanged)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::boxOutlineVisibilityChanged)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::boxWidthChanged)) {
                *result = 9;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::boxsetsAdded)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeries::*_t)(QList<QBoxSet*> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeries::boxsetsRemoved)) {
                *result = 11;
                return;
            }
        }
...
const QMetaObject QtCharts::QBoxPlotSeries::staticMetaObject = {
    { &QAbstractSeries::staticMetaObject, qt_meta_stringdata_QtCharts__QBoxPlotSeries.data,
      qt_meta_data_QtCharts__QBoxPlotSeries,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QBoxPlotSeries::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QBoxPlotSeries.stringdata0))
        return static_cast<void*>(const_cast< QBoxPlotSeries*>(this));
