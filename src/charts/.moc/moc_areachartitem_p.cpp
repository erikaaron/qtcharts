...
void QtCharts::AreaChartItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AreaChartItem *_t = static_cast<AreaChartItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (AreaChartItem::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AreaChartItem::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (AreaChartItem::*_t)(const QPointF & , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AreaChartItem::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (AreaChartItem::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AreaChartItem::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (AreaChartItem::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AreaChartItem::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (AreaChartItem::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AreaChartItem::doubleClicked)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject QtCharts::AreaChartItem::staticMetaObject = {
    { &ChartItem::staticMetaObject, qt_meta_stringdata_QtCharts__AreaChartItem.data,
      qt_meta_data_QtCharts__AreaChartItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::AreaChartItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__AreaChartItem.stringdata0))
        return static_cast<void*>(const_cast< AreaChartItem*>(this));
