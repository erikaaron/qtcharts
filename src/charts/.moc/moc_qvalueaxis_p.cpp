...
const QMetaObject QtCharts::QValueAxisPrivate::staticMetaObject = {
    { &QAbstractAxisPrivate::staticMetaObject, qt_meta_stringdata_QtCharts__QValueAxisPrivate.data,
      qt_meta_data_QtCharts__QValueAxisPrivate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QValueAxisPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QValueAxisPrivate.stringdata0))
        return static_cast<void*>(const_cast< QValueAxisPrivate*>(this));
