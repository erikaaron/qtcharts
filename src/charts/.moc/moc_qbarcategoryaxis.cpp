...
void QtCharts::QBarCategoryAxis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QBarCategoryAxis *_t = static_cast<QBarCategoryAxis *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QBarCategoryAxis::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBarCategoryAxis::categoriesChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QBarCategoryAxis::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBarCategoryAxis::minChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QBarCategoryAxis::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBarCategoryAxis::maxChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QBarCategoryAxis::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBarCategoryAxis::rangeChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QBarCategoryAxis::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBarCategoryAxis::countChanged)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject QtCharts::QBarCategoryAxis::staticMetaObject = {
    { &QAbstractAxis::staticMetaObject, qt_meta_stringdata_QtCharts__QBarCategoryAxis.data,
      qt_meta_data_QtCharts__QBarCategoryAxis,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QBarCategoryAxis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QBarCategoryAxis.stringdata0))
        return static_cast<void*>(const_cast< QBarCategoryAxis*>(this));
