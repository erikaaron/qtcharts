...
#include "../piechart/piesliceitem_p.h"
...
void QtCharts::PieSliceItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PieSliceItem::*_t)(Qt::MouseButtons );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PieSliceItem::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (PieSliceItem::*_t)(Qt::MouseButtons );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PieSliceItem::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (PieSliceItem::*_t)(Qt::MouseButtons );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PieSliceItem::doubleClicked)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject QtCharts::PieSliceItem::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_QtCharts__PieSliceItem.data,
      qt_meta_data_QtCharts__PieSliceItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
