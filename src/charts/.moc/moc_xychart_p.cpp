...
void QtCharts::XYChart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XYChart::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XYChart::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (XYChart::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XYChart::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (XYChart::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XYChart::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (XYChart::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XYChart::doubleClicked)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject QtCharts::XYChart::staticMetaObject = {
    { &ChartItem::staticMetaObject, qt_meta_stringdata_QtCharts__XYChart.data,
      qt_meta_data_QtCharts__XYChart,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::XYChart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__XYChart.stringdata0))
        return static_cast<void*>(const_cast< XYChart*>(this));
