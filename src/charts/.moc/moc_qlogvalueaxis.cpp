...
void QtCharts::QLogValueAxis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLogValueAxis::minChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QLogValueAxis::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLogValueAxis::maxChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLogValueAxis::rangeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLogValueAxis::labelFormatChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QLogValueAxis::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLogValueAxis::baseChanged)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject QtCharts::QLogValueAxis::staticMetaObject = {
    { &QAbstractAxis::staticMetaObject, qt_meta_stringdata_QtCharts__QLogValueAxis.data,
      qt_meta_data_QtCharts__QLogValueAxis,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QLogValueAxis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QLogValueAxis.stringdata0))
        return static_cast<void*>(const_cast< QLogValueAxis*>(this));
