...
void QtCharts::PolarChartLogValueAxisAngular::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PolarChartLogValueAxisAngular *_t = static_cast<PolarChartLogValueAxisAngular *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::PolarChartLogValueAxisAngular::staticMetaObject = {
    { &PolarChartAxisAngular::staticMetaObject, qt_meta_stringdata_QtCharts__PolarChartLogValueAxisAngular.data,
      qt_meta_data_QtCharts__PolarChartLogValueAxisAngular,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::PolarChartLogValueAxisAngular::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__PolarChartLogValueAxisAngular.stringdata0))
        return static_cast<void*>(const_cast< PolarChartLogValueAxisAngular*>(this));
