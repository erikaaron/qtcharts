...
#include "../candlestickchart/qcandlestickseries_p.h"
...
void QtCharts::QCandlestickSeriesPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSeriesPrivate::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QCandlestickSeriesPrivate::*_t)(int , QCandlestickSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSeriesPrivate::pressed)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QCandlestickSeriesPrivate::*_t)(int , QCandlestickSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSeriesPrivate::released)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QCandlestickSeriesPrivate::*_t)(int , QCandlestickSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSeriesPrivate::doubleClicked)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSeriesPrivate::updated)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QCandlestickSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSeriesPrivate::updatedLayout)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QCandlestickSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QCandlestickSeriesPrivate::updatedCandlesticks)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject QtCharts::QCandlestickSeriesPrivate::staticMetaObject = {
    { &QAbstractSeriesPrivate::staticMetaObject, qt_meta_stringdata_QtCharts__QCandlestickSeriesPrivate.data,
      qt_meta_data_QtCharts__QCandlestickSeriesPrivate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QCandlestickSeriesPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QCandlestickSeriesPrivate.stringdata0))
        return static_cast<void*>(const_cast< QCandlestickSeriesPrivate*>(this));
