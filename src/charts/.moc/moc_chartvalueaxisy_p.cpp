...
void QtCharts::ChartValueAxisY::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ChartValueAxisY *_t = static_cast<ChartValueAxisY *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::ChartValueAxisY::staticMetaObject = {
    { &VerticalAxis::staticMetaObject, qt_meta_stringdata_QtCharts__ChartValueAxisY.data,
      qt_meta_data_QtCharts__ChartValueAxisY,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::ChartValueAxisY::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__ChartValueAxisY.stringdata0))
        return static_cast<void*>(const_cast< ChartValueAxisY*>(this));
