...
#include "../xychart/qhxymodelmapper.h"
...
void QtCharts::QHXYModelMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHXYModelMapper::seriesReplaced)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QHXYModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHXYModelMapper::modelReplaced)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QHXYModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHXYModelMapper::xRowChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QHXYModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHXYModelMapper::yRowChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QHXYModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHXYModelMapper::firstColumnChanged)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QHXYModelMapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHXYModelMapper::columnCountChanged)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject QtCharts::QHXYModelMapper::staticMetaObject = {
    { &QXYModelMapper::staticMetaObject, qt_meta_stringdata_QtCharts__QHXYModelMapper.data,
      qt_meta_data_QtCharts__QHXYModelMapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QHXYModelMapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QHXYModelMapper.stringdata0))
        return static_cast<void*>(const_cast< QHXYModelMapper*>(this));
