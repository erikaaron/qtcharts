...
void QtCharts::Bar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Bar::*_t)(int , QBarSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bar::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Bar::*_t)(bool , int , QBarSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bar::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Bar::*_t)(int , QBarSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bar::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (Bar::*_t)(int , QBarSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bar::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (Bar::*_t)(int , QBarSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bar::doubleClicked)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject QtCharts::Bar::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtCharts__Bar.data,
      qt_meta_data_QtCharts__Bar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::Bar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< Bar*>(this));
