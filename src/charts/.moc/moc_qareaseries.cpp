...
void QtCharts::QAreaSeries::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QAreaSeries *_t = static_cast<QAreaSeries *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QAreaSeries::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(const QPointF & , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::hovered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::doubleClicked)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::selected)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::colorChanged)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::borderColorChanged)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::pointLabelsFormatChanged)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::pointLabelsVisibilityChanged)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(const QFont & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::pointLabelsFontChanged)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::pointLabelsColorChanged)) {
                *result = 11;
                return;
            }
        }
        {
            typedef void (QAreaSeries::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAreaSeries::pointLabelsClippingChanged)) {
                *result = 12;
                return;
            }
        }
...
const QMetaObject QtCharts::QAreaSeries::staticMetaObject = {
    { &QAbstractSeries::staticMetaObject, qt_meta_stringdata_QtCharts__QAreaSeries.data,
      qt_meta_data_QtCharts__QAreaSeries,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QAreaSeries::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QAreaSeries.stringdata0))
        return static_cast<void*>(const_cast< QAreaSeries*>(this));
