...
void QtCharts::LogXYDomain::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LogXYDomain *_t = static_cast<LogXYDomain *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtCharts::LogXYDomain::staticMetaObject = {
    { &AbstractDomain::staticMetaObject, qt_meta_stringdata_QtCharts__LogXYDomain.data,
      qt_meta_data_QtCharts__LogXYDomain,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::LogXYDomain::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__LogXYDomain.stringdata0))
        return static_cast<void*>(const_cast< LogXYDomain*>(this));
