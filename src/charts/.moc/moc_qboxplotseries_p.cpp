...
#include "../boxplotchart/qboxplotseries_p.h"
...
void QtCharts::QBoxPlotSeriesPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeriesPrivate::updated)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeriesPrivate::clicked)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeriesPrivate::*_t)(int , QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeriesPrivate::pressed)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeriesPrivate::*_t)(int , QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeriesPrivate::released)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeriesPrivate::*_t)(int , QBoxSet * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeriesPrivate::doubleClicked)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeriesPrivate::updatedBoxes)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeriesPrivate::updatedLayout)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (QBoxPlotSeriesPrivate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QBoxPlotSeriesPrivate::restructuredBoxes)) {
                *result = 7;
                return;
            }
        }
...
const QMetaObject QtCharts::QBoxPlotSeriesPrivate::staticMetaObject = {
    { &QAbstractSeriesPrivate::staticMetaObject, qt_meta_stringdata_QtCharts__QBoxPlotSeriesPrivate.data,
      qt_meta_data_QtCharts__QBoxPlotSeriesPrivate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtCharts::QBoxPlotSeriesPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtCharts__QBoxPlotSeriesPrivate.stringdata0))
        return static_cast<void*>(const_cast< QBoxPlotSeriesPrivate*>(this));
